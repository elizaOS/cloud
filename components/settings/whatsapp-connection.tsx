        ...
        {status?.connected ? (
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will stop your AI agent from receiving and
                      sending WhatsApp messages. You can reconnect at
                      any time.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <CollapsibleContent className="p-4 bg-muted rounded-b-lg border-t">
                <ol className="text-sm text-muted-foreground space-y-2 list-decimal list-inside">
                  ...
                  <li>
                    Go to WhatsApp {">"} API Setup to find your
                    Phone Number ID
                  </li>
                  <li>
                    Go to Settings {">"} Basic to find your App
                    Secret
                  </li>
                  <li>
                    Create a permanent access token via Meta
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Found in Meta App Dashboard under WhatsApp {">"} API
                Setup
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Found in Meta App Dashboard under Settings {">"}{" "}
                Basic
              </p>
            </div>
