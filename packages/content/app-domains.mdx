...
- **Wildcard Subdomains**: Automatic `*.apps.cloud.milady.ai` subdomains for every app
...
- **Use Subdomains First** — Test with `*.apps.cloud.milady.ai` before adding custom domains
