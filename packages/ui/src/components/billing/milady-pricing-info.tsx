/**
 * Milady-specific pricing info card for the billing page.
...
interface MiladyPricingInfoProps {
...
export function MiladyPricingInfo({
  currentCredits,
  runningAgents = 0,
  idleAgents = 0,
}: MiladyPricingInfoProps) {
  const hourlyBurn =
    runningAgents * MILADY_PRICING.RUNNING_HOURLY_RATE +
    idleAgents * MILADY_PRICING.IDLE_HOURLY_RATE;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="flex items-start gap-3 p-3 border border-white/5 bg-white/[0.02]">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-mono font-semibold text-white">
                {formatUSD(MILADY_PRICING.RUNNING_HOURLY_RATE)}/hr
              </p>
          ...
          <div className="flex items-start gap-3 p-3 border border-white/5 bg-white/[0.02]">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-mono font-semibold text-white">
                {formatUSD(MILADY_PRICING.IDLE_HOURLY_RATE)}/hr
              </p>
              <p className="text-[10px] text-white/30 font-mono">
