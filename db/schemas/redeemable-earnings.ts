...
export const redeemableEarnings = pgTable(
  "redeemable_earnings",
  {
    ...
    earned_from_miniapps: numeric("earned_from_miniapps", { precision: 18, scale: 4 })
      .notNull()
      .default("0.0000"),
    earned_from_agents: numeric("earned_from_agents", { precision: 18, scale: 4 })
      .notNull()
      .default("0.0000"),
...
export const redeemableEarningsLedger = pgTable(
  "redeemable_earnings_ledger",
  {
    ...
    balance_after: numeric("balance_after", { precision: 18, scale: 4 }).notNull(),
...
export const redeemedEarningsTracking = pgTable(
  "redeemed_earnings_tracking",
  {
    ...
    ledger_entry_id: uuid("ledger_entry_id")
      .notNull()
      .unique(), // Each earning can only be redeemed once
    ...
    amount_redeemed: numeric("amount_redeemed", { precision: 18, scale: 4 }).notNull(),
