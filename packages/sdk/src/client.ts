...
import {
  ...
  type MiladyAgentResponse,
  type MiladyLifecycleResponse,
...
export class ElizaCloudClient {
  ...
  listMiladyAgents(): Promise<MiladyAgentListResponse> {
    return this.request<MiladyAgentListResponse>("GET", "/api/v1/milady/agents");
  }

  createMiladyAgent(request: CreateMiladyAgentRequest): Promise<CreateMiladyAgentResponse> {
    return this.request<CreateMiladyAgentResponse>("POST", "/api/v1/milady/agents", {
      json: request,
    });
  }
