...
export class ElizaCloudClient {
  ...
  pollCliLogin(sessionId) {
    return this.request("GET", `/api/auth/cli-session/${encodePathParam(sessionId)}`, {
      skipAuth: true,
    });
  }
  ...
  updateContainer(containerId, request) {
    return this.request("PATCH", `/api/v1/containers/${encodePathParam(containerId)}`, {
      json: request,
    });
  }
  ...
  updateMiladyAgent(agentId, request) {
    return this.request("PATCH", `/api/v1/milady/agents/${encodePathParam(agentId)}`, {
      json: request,
    });
  }
  ...
  pollGatewayRelayRequest(sessionId, timeoutMs) {
    return this.v1.get(`/milady/gateway-relay/sessions/${encodePathParam(sessionId)}/next`, {
