...
const TREND_STYLES: Record<"up" | "down" | "neutral", { bg: string; text: string; icon: LucideIcon }> = {
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          {trend && (
            ...
            >
              ...
              {trend.percentage !== undefined ? `${trend.percentage}%` : trend.label}
            </Badge>
          )}
        </div>
      </CardHeader>
      <CardContent className={cn("space-y-3", isCompact ? "px-4 pb-4" : "px-5 pb-5")}>
