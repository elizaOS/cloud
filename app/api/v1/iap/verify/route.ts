 ...
 */
async function verifyAppleReceipt(receipt: string): Promise<VerificationResponse> {
  ...
  return { valid: false, error: "Receipt verification failed on all endpoints" };
}
...
async function verifyGooglePurchase(
  ...
  return { valid: false, error: `Invalid purchase state: ${purchase.purchaseState}` };
}
