 ...
 *
 * Validates HS256-signed JWTs issued by waifu-core's MiladyClient.
 * Env: MILADY_SERVICE_JWT_SECRET -- shared secret with waifu-core.
 */
...
export function isServiceJwtEnabled(): boolean {
  return !!process.env[SECRET_ENV_KEY];
}
