...
// Replacements for `nextra/components` named exports used in our MDX content.
// Aliased via `vite.config.ts` so existing `import { Callout, Cards, Steps,
// Tabs } from "nextra/components"` lines in `content/**/*.mdx` resolve here
// without rewriting the MDX sources.
