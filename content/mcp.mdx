...
```bash
curl -X GET "https://cloud.eliza.ai/api/mcp/stream" \
...
```bash
curl -X POST "https://cloud.eliza.ai/api/mcp/proxy/{mcpId}" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "jsonrpc": "2.0",
...
<Cards>
  <Cards.Card title="Clear Schemas">
    Provide detailed input schemas
  </Cards.Card>
  <Cards.Card title="Good Descriptions">
    Help models understand tool purposes
  </Cards.Card>
  <Cards.Card title="Handle Errors">
    Return clear error messages
  </Cards.Card>
  <Cards.Card title="Validate Input">
