...
describe("Trigger API Endpoints", () => {
  ...
  test.skipIf(skipHttp)(
    "GET /api/v1/n8n/triggers requires workflowId",
    async () => {
      const response = await fetchWithTimeout(
        `${BASE_URL}/api/v1/n8n/triggers`,
        {
          method: "GET",
          headers: authHeaders(),
        },
  ...
  test.skipIf(skipHttp || !testWorkflowId)(
    "POST /api/v1/n8n/triggers creates webhook trigger",
    async () => {
  ...
  test.skipIf(skipHttp || !testWorkflowId)(
    "POST /api/v1/n8n/triggers creates cron trigger",
    async () => {
      if (!testWorkflowId) return;
  ...
  test.skipIf(skipHttp || !testWorkflowId)(
    "POST /api/v1/n8n/triggers creates A2A trigger",
    async () => {
      if (!testWorkflowId) return;
  ...
  test.skipIf(skipHttp || !testWorkflowId)(
    "POST /api/v1/n8n/triggers creates MCP trigger",
    async () => {
      if (!testWorkflowId) return;
  ...
  test.skipIf(skipHttp || !testWorkflowId)(
    "GET /api/v1/n8n/triggers lists triggers",
    async () => {
      if (!testWorkflowId) return;
      ...
      const webhookTrigger = data.triggers.find(
        (t: { triggerType: string }) => t.triggerType === "webhook",
      );
      if (webhookTrigger) {
  ...
  test.skipIf(skipHttp || !testTriggerId)(
    "GET /api/v1/n8n/triggers/:id gets single trigger",
    async () => {
  ...
  test.skipIf(skipHttp || !testTriggerId)(
    "PATCH /api/v1/n8n/triggers/:id updates trigger",
    async () => {
      if (!testTriggerId) return;
  ...
  test.skipIf(skipHttp || !testTriggerId)(
    "POST /api/v1/n8n/triggers/:id/regenerate-secret regenerates secret",
    async () => {
      if (!testTriggerId) return;
...
describe("Webhook Endpoint", () => {
  test.skipIf(skipHttp)(
    "GET /api/v1/n8n/webhooks/:key returns 404 for unknown key",
    async () => {
      const response = await fetchWithTimeout(
  ...
  test.skipIf(skipHttp)(
    "POST /api/v1/n8n/webhooks/:key returns 404 for unknown key",
    async () => {
      const response = await fetchWithTimeout(
        `${BASE_URL}/api/v1/n8n/webhooks/nonexistent-key`,
        {
  ...
  test.skipIf(skipHttp)(
    "POST /api/v1/n8n/webhooks/:key returns 401 without signature",
    async () => {
...
describe("A2A Trigger Skills", () => {
  ...
  test.skipIf(skipHttp)(
    "n8n_list_triggers skill returns triggers",
    async () => {
  ...
  test.skipIf(skipHttp)(
    "n8n_trigger_workflow skill requires trigger key or workflow id",
    async () => {
  ...
  test.skipIf(skipHttp)(
    "n8n_create_trigger skill requires workflowId",
    async () => {
      const result = await a2aPost(
        skillMessage("n8n_create_trigger", {
          triggerType: "webhook",
        }),
      );
      if (!result) return;
...
describe("MCP Trigger Tools", () => {
  ...
  test.skipIf(skipHttp)("n8n_list_triggers tool lists triggers", async () => {
    ...
    if (result.data.result) {
      const content = result.data.result as {
  ...
  test.skipIf(skipHttp)(
    "n8n_execute_trigger tool requires trigger key or workflow id",
    async () => {
  ...
  test.skipIf(skipHttp)("n8n_create_trigger tool validates input", async () => {
    const result = await mcpPost(
      mcpToolCall("n8n_create_trigger", {
        triggerType: "cron",
    ...
    if (result.data.result) {
      ...
      expect(
        content.isError || content.content[0]?.text?.includes("error"),
      ).toBe(true);
    }
  });
});
...
describe("Cron Trigger Endpoint", () => {
  ...
  test.skipIf(skipHttp || skipCron)(
    "POST /api/cron/n8n-workflow-triggers requires auth",
    async () => {
      const response = await fetchWithTimeout(
  ...
  test.skipIf(skipHttp || skipCron)(
    "POST /api/cron/n8n-workflow-triggers processes triggers",
    async () => {
      const response = await fetchWithTimeout(
        `${BASE_URL}/api/cron/n8n-workflow-triggers`,
        {
  ...
  test.skipIf(skipHttp || skipCron)(
    "GET /api/cron/n8n-workflow-triggers returns status",
    async () => {
      const response = await fetchWithTimeout(
        `${BASE_URL}/api/cron/n8n-workflow-triggers`,
        {
...
describe("Error Response Consistency", () => {
  test.skipIf(skipHttp)(
    "all trigger endpoints return consistent error format",
    async () => {
      const endpoints = [
  ...
  test.skipIf(skipHttp)(
    "webhooks return generic error to prevent enumeration",
    async () => {
      const response = await fetchWithTimeout(
