...
- **USE pre-built components** from "@elizaos/cloud-ui/components/eliza":
...
\`\`\`typescript
import { useEliza } from "@elizaos/cloud-ui/components/eliza";
...
\`\`\`typescript
import { useElizaCredits } from "@elizaos/cloud-ui/components/eliza";
...
\`\`\`typescript
import { CreditDisplay } from "@elizaos/cloud-ui/components/eliza";
...
\`\`\`typescript
import { LowBalanceWarning } from "@elizaos/cloud-ui/components/eliza";
...
### SignInButton
\`\`\`typescript
import { SignInButton } from "@elizaos/cloud-ui/components/eliza";
...
### UserMenu
\`\`\`typescript
import { UserMenu } from "@elizaos/cloud-ui/components/eliza";
...
### ProtectedRoute
\`\`\`typescript
import { ProtectedRoute } from "@elizaos/cloud-ui/components/eliza";
...
### useElizaAuth Hook
\`\`\`typescript
import { useElizaAuth } from "@elizaos/cloud-ui/components/eliza";
...
### useAppCredits Hook
\`\`\`typescript
import { useAppCredits } from "@elizaos/cloud-ui/components/eliza";
...
### AppCreditDisplay
\`\`\`typescript
import { AppCreditDisplay } from "@elizaos/cloud-ui/components/eliza";
...
\`\`\`typescript
import { PurchaseCreditsButton } from "@elizaos/cloud-ui/components/eliza";
...
### CreditBalanceCard
\`\`\`typescript
import { CreditBalanceCard } from "@elizaos/cloud-ui/components/eliza";
...
export default function ImagePage() {
  ...
  "credits-display": {
    ...
    code: `'use client';
import { useElizaCredits, CreditDisplay, LowBalanceWarning } from "@elizaos/cloud-ui/components/eliza";
...
export default function AIFormPage() {
  ...
  "user-auth": {
    ...
    code: `'use client';
import { useElizaAuth, SignInButton, SignOutButton, UserMenu } from "@elizaos/cloud-ui/components/eliza";
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  "user-credits": {
    ...
    code: `'use client';
import { useAppCredits, AppCreditDisplay, AppLowBalanceWarning, CreditBalanceCard } from "@elizaos/cloud-ui/components/eliza";
...
export default function BillingPage() {
  ...
  "credit-purchase": {
    ...
    code: `'use client';
import { useState } from 'react';
import { useAppCredits, PurchaseCreditsModal, PurchaseCreditsButton } from "@elizaos/cloud-ui/components/eliza";
