...
<Cards>
  <Cards.Card title="Quality Content" href="/docs/knowledge">
    Use well-structured, accurate documents
  </Cards.Card>
  <Cards.Card title="Organize" href="/docs/knowledge">
    Group related documents for better retrieval
  </Cards.Card>
  <Cards.Card title="Update Regularly" href="/docs/knowledge">
    Keep knowledge current by refreshing documents
  </Cards.Card>
  <Cards.Card title="Test Queries" href="/docs/knowledge">
