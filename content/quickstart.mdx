...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 mb-8">
  ...
  >
    <div className="relative z-10">
      <div className="font-bold text-white text-lg mb-1 group-hover:text-[#ff5800] transition-colors">
        Visual Builder
      </div>
      <div className="text-white/50 text-sm">Build agents with our no-code editor</div>
    </div>
  </a>
  ...
  >
    <div className="relative z-10">
      <div className="font-bold text-white text-lg mb-1 group-hover:text-[#0b35f1] transition-colors">
        API Integration
      </div>
      <div className="text-white/50 text-sm">Integrate via REST API</div>
    </div>
  </a>
  ...
  >
    <div className="relative z-10">
      <div className="font-bold text-white text-lg mb-1 group-hover:text-[#22c55e] transition-colors">
        CLI Deployment
      </div>
      <div className="text-white/50 text-sm">Deploy with the elizaOS CLI</div>
    </div>
  </a>
</div>
