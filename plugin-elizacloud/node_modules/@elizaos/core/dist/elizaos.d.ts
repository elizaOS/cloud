import type { Character, IAgentRuntime, IElizaOS, UUID, Memory, State, Plugin, RuntimeSettings, Content, SendMessageOptions, SendMessageResult, IDatabaseAdapter } from '../src/types';
/**
