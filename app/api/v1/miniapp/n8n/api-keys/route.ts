/**
 * Miniapp N8N API Keys API
 *
 * GET /api/v1/miniapp/n8n/api-keys - List API keys (global)
 * POST /api/v1/miniapp/n8n/api-keys - Create API key
 */
...
/**
 * GET /api/v1/miniapp/n8n/api-keys
...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error("[Miniapp N8N API Keys] Error listing API keys:", error);
    return NextResponse.json(
      {
        success: false,
...
/**
 * POST /api/v1/miniapp/n8n/api-keys
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Miniapp N8N API Keys] Created API key: ${name}`, {
      appId: app.id,
    ...
    logger.error("[Miniapp N8N API Keys] Error creating API key:", error);
    return NextResponse.json(
      {
        success: false,
