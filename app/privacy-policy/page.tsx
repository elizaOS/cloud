            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  Welcome to elizaOS (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;). We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Service.
                </p>
              </section>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-white">3. Automatically Collected Information</h2>
                <p className="text-white/80 leading-relaxed">
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-white/80 ml-4">
                  ...
                  <li>To protect the rights, property, or safety of elizaOS, our users, or others</li>
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  We use cookies and similar tracking technologies to collect and track information about your use of our Service. You can control cookies through your browser settings, but disabling cookies may affect your ability to use certain features of our Service.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  Our Service may contain links to third-party websites or services that are not owned or controlled by elizaOS. We are not responsible for the privacy practices of these third parties. We encourage you to review their privacy policies.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  Your information may be transferred to and maintained on computers located outside of your state, province, country, or other governmental jurisdiction where privacy laws may differ. By using our Service, you consent to this transfer.
                </p>
              </section>
