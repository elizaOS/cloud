/**
 * Miniapp N8N Workflow Versions API
 *
 * GET /api/v1/miniapp/n8n/workflows/:id/versions - List versions
 * POST /api/v1/miniapp/n8n/workflows/:id/versions/:version/revert - Revert to version
 */
...
/**
 * GET /api/v1/miniapp/n8n/workflows/:id/versions
...
export async function GET(
  ...
  try {
    ...
    logger.error("[Miniapp N8N Workflows] Error listing versions:", error);
    return NextResponse.json(
      {
        success: false,
