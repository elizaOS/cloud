...
test.describe("Voice Listing API", () => {
  ...
  test("GET /api/elevenlabs/voices lists available voices", async ({
    request,
  }) => {
  ...
  test("GET /api/elevenlabs/voices/:id returns voice details", async ({
    request,
  }) => {
    // First get list of voices
    const listResponse = await request.get(
      `${CLOUD_URL}/api/elevenlabs/voices`,
      {
        headers: authHeaders(),
      },
    );
    ...
    const response = await request.get(
      `${CLOUD_URL}/api/elevenlabs/voices/${voiceId}`,
      {
        headers: authHeaders(),
      },
    );
  ...
  test("GET /api/elevenlabs/voices/user returns user's voices", async ({
    request,
  }) => {
    const response = await request.get(
      `${CLOUD_URL}/api/elevenlabs/voices/user`,
      {
        headers: authHeaders(),
      },
    );
  ...
  test("GET /api/elevenlabs/voices/jobs returns voice jobs", async ({
    request,
  }) => {
    const response = await request.get(
      `${CLOUD_URL}/api/elevenlabs/voices/jobs`,
      {
        headers: authHeaders(),
      },
    );
...
test.describe("Voice Cloning API", () => {
  ...
  test("POST /api/elevenlabs/voices/clone initiates voice cloning", async ({
    request,
  }) => {
    ...
    const response = await request.post(
      `${CLOUD_URL}/api/elevenlabs/voices/clone`,
      {
        headers: {
          Authorization: `Bearer ${API_KEY}`,
        },
    ...
    if (response.status() === 200 || response.status() === 201) {
      ...
      console.log(
        "✅ Voice cloning requires audio samples (expected validation error)",
      );
    } else {
...
test.describe("Voice Verification API", () => {
  ...
  test("POST /api/elevenlabs/voices/verify/:id verifies voice", async ({
    request,
  }) => {
    ...
    // Verify voice
    const response = await request.post(
      `${CLOUD_URL}/api/elevenlabs/voices/verify/${voiceId}`,
      {
        headers: authHeaders(),
      },
    );
...
test.describe("Text-to-Speech API", () => {
  ...
  test("POST /api/elevenlabs/tts generates speech from text", async ({
    request,
  }) => {
...
test.describe("Voice Selection in Chat", () => {
  test("chat page has voice selection", async ({ page }) => {
    ...
    if (selectorCount > 0) {
      console.log(
        `✅ Found ${selectorCount} voice selection element(s) in chat`,
      );
    } else {
