...
const LOCAL_DATABASE_URL = "postgresql://eliza_dev:local_dev_password@localhost:5432/eliza_dev";
...
async function verifySetup() {
    ...
    try {
        ...
        log(`✓ Database has ${userCount.rows[0].count} users and ${orgCount.rows[0].count} organizations`);
        return true;
    } catch (e) {
