/**
 * N8N Workflow Executions API
 *
 * GET /api/v1/n8n/workflows/:id/executions - List execution history
 */
...
/**
 * GET /api/v1/n8n/workflows/:id/executions
...
export async function GET(
  ...
  try {
    ...
    logger.error("[N8N Executions] Error listing executions:", error);
    return NextResponse.json(
      {
        success: false,
