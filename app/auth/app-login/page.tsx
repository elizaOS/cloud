  ...
  const completeLogin = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        `/api/auth/app-session/${sessionId}/complete`,
        {
          method: "POST",
...
/**
 * App login page for authenticating app users.
 * Handles Privy authentication and redirects back to the app callback URL.
 */
