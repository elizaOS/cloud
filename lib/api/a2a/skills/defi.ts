...
export async function executeSkillGetTokenPrice(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillGetTrendingTokens(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillGetMarketOverview(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillSolanaTokenOverview(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillSolanaWalletPortfolio(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillJupiterQuote(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillHeliusTransactions(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillZeroExQuote(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
  ...
  if (!sellToken || !buyToken || !sellAmount)
    throw new Error("sellToken, buyToken, and sellAmount are required");
...
export async function executeSkillSearchTokens(
  text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillGetTokenHolders(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillGetOHLCV(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
...
export async function executeSkillDeFiHealthCheck(
  _text: string,
  data: Data,
  _ctx: A2AContext,
) {
