...
```json
{
  ...
  "bio": [
    "First bio statement",
    "Second bio statement"
  ],
  "lore": [
    "Background story element",
    "Another lore element"
  ],
  "style": {
...
```json
{
  "settings": {
    "mcp": {
      "enabled": true,
      "servers": [
        { "id": "weather", "url": "https://mcp.eliza.ai/weather" }
      ]
    }
  }
}
...
<Cards>
  <Cards.Card title="Be Specific" href="/docs/character-json">
    Detailed bios and styles produce more consistent agents
  </Cards.Card>
  <Cards.Card title="Test Thoroughly" href="/docs/character-json">
    Try various scenarios before deploying
  </Cards.Card>
  <Cards.Card title="Iterate" href="/docs/character-json">
    Refine based on actual conversations
  </Cards.Card>
  <Cards.Card title="Version Control" href="/docs/character-json">
    Track changes to your character files
  </Cards.Card>
</Cards>
