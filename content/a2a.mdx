...
<Cards>
  <Cards.Card title="Clear Skills" href="/docs/a2a">
    Define agent capabilities clearly
  </Cards.Card>
  <Cards.Card title="Handle Errors" href="/docs/a2a">
    Implement robust error handling
  </Cards.Card>
  <Cards.Card title="Rate Limiting" href="/docs/a2a">
    Respect rate limits of other agents
  </Cards.Card>
  <Cards.Card title="Security" href="/docs/a2a">
