 ...
 *
 * Tests verifyCronSecret() with realistic NextRequest objects
...
describe("Cron Auth Integration", () => {
  ...
  // =========================================================================
  // Missing CRON_SECRET → 500 with correct body
  // =========================================================================
  ...
  describe("missing CRON_SECRET", () => {
    ...
    it("returns 500 NextResponse with error body", async () => {
      const req = makeRequest({ authorization: `Bearer ${TEST_SECRET}` });
  ...
  describe("wrong secret", () => {
    ...
    it("returns 401 NextResponse with Unauthorized body", async () => {
