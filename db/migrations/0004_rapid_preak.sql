...
--> statement-breakpoint
ALTER TABLE "fragment_projects" ALTER COLUMN "fragment_data" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "fragment_projects" ADD COLUMN "builder_mode" text DEFAULT 'fragment' NOT NULL;--> statement-breakpoint
ALTER TABLE "fragment_projects" ADD COLUMN "sandbox_id" text;--> statement-breakpoint
ALTER TABLE "fragment_projects" ADD COLUMN "sandbox_url" text;--> statement-breakpoint
ALTER TABLE "fragment_projects" ADD COLUMN "sandbox_expires_at" timestamp;--> statement-breakpoint
ALTER TABLE "fragment_projects" ADD COLUMN "messages" jsonb DEFAULT '[]'::jsonb;--> statement-breakpoint
ALTER TABLE "fragment_projects" ADD COLUMN "generated_files" jsonb DEFAULT '[]'::jsonb;--> statement-breakpoint
ALTER TABLE "fragment_projects" ADD COLUMN "build_config" jsonb DEFAULT '{}'::jsonb;--> statement-breakpoint
ALTER TABLE "fragment_projects" ADD COLUMN "cpu_seconds_used" integer DEFAULT 0;--> statement-breakpoint
...
CREATE INDEX "fragment_projects_builder_mode_idx" ON "fragment_projects" USING btree ("builder_mode");--> statement-breakpoint
CREATE INDEX "fragment_projects_sandbox_id_idx" ON "fragment_projects" USING btree ("sandbox_id");