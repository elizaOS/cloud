...
describe("Mode Switching During Operations", () => {
   ...
   */
  it("should handle mode switch from ASSISTANT to CHAT during DB operations", async () => {
    ...
    const simulateEvaluatorOperations = async (label: string): Promise<void> => {
      try {
        ...
        await assistantRuntime.countMemories(
        ...
        await assistantRuntime.getMemories({
          tableName: "messages",
    ...
    const poolErrors = errors.filter(err =>
      err.toLowerCase().includes("pool") ||
   ...
   */
  it("should handle rapid mode switches between CHAT and ASSISTANT", async () => {
...
describe("Service Access During Invalidation", () => {
   ...
   */
  it("should handle knowledge service access during invalidation", async () => {
   ...
   */
  it("should handle memory service operations during invalidation", async () => {
...
describe("Concurrent Configuration Changes", () => {
   ...
   */
  it("should handle concurrent invalidations from multiple sources", async () => {
   ...
   */
  it("should handle plugin configuration changes during queries", async () => {
...
describe("Long-Running Operation Simulation", () => {
   ...
   */
  it("should handle evaluator-like operation sequence during invalidation", async () => {
