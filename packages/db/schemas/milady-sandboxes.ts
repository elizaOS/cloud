...
export const miladySandboxes = pgTable(
  "milady_sandboxes",
  {
    ...
    hourly_rate: numeric("hourly_rate", { precision: 10, scale: 4 }).default(
      "0.0100",
    ),
  ...
  (table) => ({
    organization_idx: index("milady_sandboxes_organization_idx").on(
    ...
    character_idx: index("milady_sandboxes_character_idx").on(
      table.character_id,
    ),
    sandbox_id_idx: index("milady_sandboxes_sandbox_id_idx").on(
      table.sandbox_id,
    ),
    billing_status_idx: index("milady_sandboxes_billing_status_idx").on(
...
export const miladySandboxBackups = pgTable(
  ...
  (table) => ({
    sandbox_record_idx: index("milady_sandbox_backups_sandbox_idx").on(
      table.sandbox_record_id,
    ),
    created_at_idx: index("milady_sandbox_backups_created_at_idx").on(
      table.created_at,
    ),
  }),
);
