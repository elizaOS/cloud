...
export const PROXY_CONFIG = {
  ...
  PRICING_CACHE_STALE_TIME: parseInt(
    process.env.PRICING_CACHE_STALE_TIME || "150",
  ),
  ...
  HELIUS_MAINNET_URL:
    process.env.HELIUS_MAINNET_URL || "https://mainnet.helius-rpc.com",
  HELIUS_DEVNET_URL:
    process.env.HELIUS_DEVNET_URL || "https://devnet.helius-rpc.com",
  ...
  RPC_INITIAL_RETRY_DELAY_MS: parseInt(
    process.env.RPC_INITIAL_RETRY_DELAY_MS || "1000",
  ),
  RPC_MAX_RETRY_DELAY_MS: parseInt(
    process.env.RPC_MAX_RETRY_DELAY_MS || "16000",
  ),
  ...
  RPC_EXPENSIVE_MAX_RETRIES: parseInt(
    process.env.RPC_EXPENSIVE_MAX_RETRIES || "2",
  ),
  ...
  RPC_CIRCUIT_FAILURE_THRESHOLD: parseInt(
    process.env.RPC_CIRCUIT_FAILURE_THRESHOLD || "10",
  ),
  RPC_CIRCUIT_OPEN_DURATION_MS: parseInt(
    process.env.RPC_CIRCUIT_OPEN_DURATION_MS || "30000",
  ),

  // Market Data API configuration
  MARKET_DATA_BASE_URL:
    process.env.MARKET_DATA_BASE_URL || "https://public-api.birdeye.so",
  MARKET_DATA_TIMEOUT_MS: parseInt(
    process.env.MARKET_DATA_TIMEOUT_MS || "15000",
  ),
  ...
  ALCHEMY_INITIAL_RETRY_DELAY_MS: parseInt(
    process.env.ALCHEMY_INITIAL_RETRY_DELAY_MS || "500",
  ),
