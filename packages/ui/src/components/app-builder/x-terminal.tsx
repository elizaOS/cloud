...
export function WebTerminal({
  ...
  const executeCommand = useCallback(
    async (command: string) => {
      ...
      if (trimmedCommand === "help") {
        ...
        term.write(
          "\x1b[38;5;245m│\x1b[0m  \x1b[1;38;5;208mMilady Cloud Sandbox Terminal\x1b[0m                            \x1b[38;5;245m│\x1b[0m\r\n",
        );
        term.write(
          "\x1b[38;5;245m├────────────────────────────────────────────────────────────┤\x1b[0m\r\n",
        );
  ...
  useEffect(() => {
    ...
    term.write(
      "\x1b[38;5;208m│\x1b[0m  \x1b[1mMilady Cloud Sandbox Terminal\x1b[0m          \x1b[38;5;208m│\x1b[0m\r\n",
    );
    term.write(
