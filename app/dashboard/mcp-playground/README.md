...
- `generate_text` - AI text generation (5-100 credits)
- `generate_image` - AI image generation (50 credits)
- `save_memory` - Long-term memory storage (1 credit)
- `retrieve_memories` - Semantic memory search (0.1-5 credits)
- `chat_with_agent` - Agent conversation (5-100 credits)
