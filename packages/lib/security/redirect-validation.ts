 ...
 *
 * Milady's desktop dev server binds to localhost on a pre-picked free port
 ...
 *   - absolute URLs whose origin is in `allowedAbsoluteOrigins` (Milady app
