      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            ...
            Develop your agent locally with hot-reload capabilities using our powerful runtime.
            Test your actions, providers, and services in a safe sandbox environment. Connect
            to Discord, Telegram, Twitter, or any platform to validate your agent&apos;s behavior
            before going live.
          </p>
          <div className="grid grid-cols-2 gap-4">
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            ...
            and persistent memory—no DevOps required.
          </p>
          <div className="grid grid-cols-2 gap-4">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center md:px-6">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <Link href="https://docs.eliza.os" target="_blank" className="flex items-center gap-2">
                  View Documentation
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
            ...
            <div className="md:col-span-4">
              ...
              <div className="flex gap-3">
                <Link href="https://github.com/elizaos" target="_blank" className="h-9 w-9 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center transition-colors">
                ...
                <Link href="https://twitter.com/elizaos" target="_blank" className="h-9 w-9 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center transition-colors">
                  <svg className="h-4 w-4 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </Link>
                <Link href="https://discord.gg/elizaos" target="_blank" className="h-9 w-9 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center transition-colors">
                  <svg className="h-4 w-4 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="https://docs.eliza.os" target="_blank" className="text-sm text-gray-400 hover:text-white transition-colors">Documentation</Link></li>
              </ul>
            </div>
