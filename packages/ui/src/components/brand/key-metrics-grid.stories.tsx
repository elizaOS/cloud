...
const sampleMetrics = [
  ...
  { label: "Growth", value: "+23%", icon: TrendingUp, accent: "rose" as const, delta: { value: "+5.2%", trend: "up" as const, label: "vs last week" } },
];
...
export const WithTrends: Story = {
  args: {
    metrics: [
      { label: "Revenue", value: "$45,231", icon: DollarSign, accent: "emerald" as const, delta: { value: "+12.5%", trend: "up" as const, label: "vs last month" } },
      { label: "Users", value: "2,341", icon: Users, accent: "violet" as const, delta: { value: "-3.1%", trend: "down" as const } },
      { label: "Requests", value: "89,123", icon: Activity, accent: "sky" as const, delta: { value: "0%", trend: "neutral" as const } },
    ],
    columns: 3,
  },
};
