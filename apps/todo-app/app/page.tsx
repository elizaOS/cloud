...
const features = [
  {
    icon: Target,
    title: "Daily Habits",
    description: "Build lasting habits with streak tracking and bonus points.",
  },
  {
    icon: Zap,
    title: "Priority Tasks",
    description:
      "Manage tasks with smart prioritization. Higher priority = more points.",
  },
  {
    icon: Star,
    title: "Goals",
    description: "Set big goals and track progress towards milestones.",
  },
  {
    icon: Trophy,
    title: "Gamification",
    description: "Level up, earn points, and track your progress.",
  },
  {
    icon: MessageSquare,
    title: "AI Assistant",
    description: "Chat naturally to create and manage tasks.",
  },
  {
    icon: Calendar,
    title: "Smart Reminders",
    description: "Get reminders based on priority and deadlines.",
  },
];
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            The intelligent task manager that helps you build habits, crush
            goals, and level up your productivity.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={handleGetStarted}
              className="px-8 py-4 bg-primary text-primary-foreground rounded-xl font-semibold text-lg hover:bg-primary/90 transition-all hover:scale-105 flex items-center gap-2"
            >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-4 flex-wrap">
            ...
            {levels.map((level) => (
              <div
                key={level.level}
                className={`px-4 py-2 rounded-lg bg-gradient-to-r ${level.color} text-white text-sm font-medium`}
              >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-muted-foreground">
                Up to 5x points for daily habits
              </div>
            </div>
            <div>
