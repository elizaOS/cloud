...
export function VideoPageClient({
  ...
  const updateUsageAfterCompletion = useCallback(
      ...
      <section className="flex flex-col gap-6 rounded-3xl border border-border/60 bg-background/80 p-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2">
            <Badge variant="outline" className="w-fit rounded-full border-primary/40 bg-primary/5 px-3 py-1 text-xs uppercase tracking-wide text-primary">
              Video studio
            </Badge>
            <div className="space-y-2">
              ...
              <p className="max-w-3xl text-sm text-muted-foreground md:text-base">
                Generate stunning clips, iterate on creative directions, and keep an eye on usage — all in one streamlined workspace tailored for video experimentation.
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-2 sm:flex-row">
            <Button variant="outline" className="rounded-xl border-border/70 bg-background" asChild>
              <Link href="https://fal.ai/models/flux" target="_blank" rel="noreferrer">
      ...
      <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] xl:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)]">
        <Card className="border-border/60 bg-background/80">
          <CardHeader>
            ...
            <CardDescription>
              Track your render capacity and plan ahead as we connect live credits.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-border/60 bg-background/70 p-4">
                ...
                <p className="text-xs text-muted-foreground">Using speed-optimized models</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-medium text-foreground">{creditProgress}%</span>
              </div>
              <Progress value={creditProgress} className="h-2" />
              <p className="text-xs text-muted-foreground">
                Credits reset on the 1st of every month. Reach out if you need a larger allocation.
              </p>
            </div>
          </CardContent>
        </Card>

        <Card className="flex h-full flex-col border-border/60 bg-background/80" id="recent-renders">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-lg font-semibold">
              ...
              >
                <div className="flex flex-wrap items-center gap-2">
                  <Badge
                    ...
                    className={cn(
                      ...
                      video.status === "failed" && "bg-destructive/20 text-destructive"
                    )}
                  >
                    {video.status}
                  </Badge>
                ...
                {video.requestId ? (
                  <div className="flex flex-wrap items-center gap-2 text-[11px] text-muted-foreground">
                    <span className="font-medium text-foreground/80">Request ID:</span>
