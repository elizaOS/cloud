/**
 * App N8N Workflow API Keys API
 *
 * GET /api/v1/app/n8n/workflows/:id/api-keys - List workflow API keys
 * POST /api/v1/app/n8n/workflows/:id/api-keys - Create workflow API key
 */
...
/**
 * GET /api/v1/app/n8n/workflows/:id/api-keys
...
/**
 * POST /api/v1/app/n8n/workflows/:id/api-keys
