...
export const appAuthSessions = pgTable("app_auth_sessions", {
  ...
  // Where to redirect after auth (app URL)
...
export type AppAuthSession = typeof appAuthSessions.$inferSelect;
export type NewAppAuthSession = typeof appAuthSessions.$inferInsert;
