...
function makeSandbox(overrides: Partial<MiladySandbox> = {}): MiladySandbox {
  return {
    ...
    container_name: "milady-aaaaaaaa",
    bridge_port: 18800,
    web_ui_port: 20100,
...
describe("toCompatAgent", () => {
  test("maps running sandbox to milady-cloud Agent shape", () => {
    ...
    expect(agent.container_id).toBe("milady-aaaaaaaa");
