...
//           <StatCard label="Total Apps" value={stats.total} icon={<Grid3x3 className="h-5 w-5 text-[#FF5800]" />} />
//           <StatCard label="Active Apps" value={stats.active} icon={<Activity className="h-5 w-5 text-green-500" />} />
//           <StatCard label="Total Users" value={stats.totalUsers.toLocaleString()} icon={<Users className="h-5 w-5 text-blue-500" />} />
//           <StatCard label="Total Requests" value={stats.totalRequests.toLocaleString()} icon={<TrendingUp className="h-5 w-5 text-purple-500" />} />
//         </div>
//         {apps.length === 0 ? (
//           <AppsEmptyState />
//         ) : (
