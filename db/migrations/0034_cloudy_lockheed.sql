...
CREATE TYPE "public"."platform_credential_type" AS ENUM('discord', 'telegram', 'twitter', 'gmail', 'slack', 'github', 'google', 'bluesky', 'reddit', 'facebook', 'instagram', 'tiktok', 'linkedin', 'mastodon', 'twilio', 'google_calendar', 'linear', 'notion', 'hubspot', 'salesforce', 'jira', 'asana', 'airtable', 'dropbox', 'spotify', 'zoom', 'microsoft');--> statement-breakpoint
...
CREATE TYPE "public"."referral_commission_tier" AS ENUM('pct_5', 'pct_50');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "milaidy_sandbox_backups" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "milaidy_sandboxes" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"organization_id" uuid NOT NULL,
	"user_id" uuid NOT NULL,
	"character_id" uuid,
...
CREATE TABLE "referral_codes" (
	...
	"user_id" uuid NOT NULL,
	"code" text NOT NULL,
	"commission_tier" "referral_commission_tier" DEFAULT 'pct_5' NOT NULL,
...
ALTER TABLE "milaidy_sandbox_backups" ADD CONSTRAINT "milaidy_sandbox_backups_sandbox_record_id_milaidy_sandboxes_id_fk" FOREIGN KEY ("sandbox_record_id") REFERENCES "public"."milaidy_sandboxes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "milaidy_sandboxes" ADD CONSTRAINT "milaidy_sandboxes_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "milaidy_sandboxes" ADD CONSTRAINT "milaidy_sandboxes_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "milaidy_sandboxes" ADD CONSTRAINT "milaidy_sandboxes_character_id_user_characters_id_fk" FOREIGN KEY ("character_id") REFERENCES "public"."user_characters"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "daily_metrics_date_platform_idx" ON "daily_metrics" USING btree ("date","platform");--> statement-breakpoint
...
CREATE INDEX "milaidy_sandbox_backups_sandbox_idx" ON "milaidy_sandbox_backups" USING btree ("sandbox_record_id");--> statement-breakpoint
CREATE INDEX "milaidy_sandbox_backups_created_at_idx" ON "milaidy_sandbox_backups" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "milaidy_sandboxes_organization_idx" ON "milaidy_sandboxes" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX "milaidy_sandboxes_user_idx" ON "milaidy_sandboxes" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "milaidy_sandboxes_status_idx" ON "milaidy_sandboxes" USING btree ("status");--> statement-breakpoint
CREATE INDEX "milaidy_sandboxes_character_idx" ON "milaidy_sandboxes" USING btree ("character_id");--> statement-breakpoint
CREATE INDEX "milaidy_sandboxes_sandbox_id_idx" ON "milaidy_sandboxes" USING btree ("sandbox_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_user_cred" ON "n8n_workflow"."credential_mappings" USING btree ("user_id","cred_type");--> statement-breakpoint
...
CREATE UNIQUE INDEX "retention_cohorts_cohort_platform_idx" ON "retention_cohorts" USING btree ("cohort_date","platform");--> statement-breakpoint
...
CREATE INDEX "webhook_events_provider_processed_idx" ON "webhook_events" USING btree ("provider","processed_at");