...
export const oauthRevokeAction: ActionWithParams = {
  ...
  similes: [
    ...
    "DISCONNECT_SALESFORCE", "REMOVE_SALESFORCE", "UNLINK_SALESFORCE",
    "DISCONNECT_AIRTABLE", "REMOVE_AIRTABLE", "UNLINK_AIRTABLE",
  ],
  description:
  ...
  parameters: {
    platform: {
      type: "string",
      description: "Platform to disconnect: google, linear, slack, github, notion, salesforce, airtable",
      required: true,
    },
  },
