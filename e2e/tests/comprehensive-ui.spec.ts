...
test.describe("Landing Page - All Buttons", () => {
  ...
  test("OS toggle buttons work", async ({ page }) => {
    ...
    const macosBtn = page
      .locator('button:has-text("macOS"), button:has-text("MACOS")')
      .first();
    const windowsBtn = page
      .locator('button:has-text("Windows"), button:has-text("WINDOWS")')
      .first();
  ...
  test("documentation links work", async ({ page }) => {
    ...
    const docLinks = page.locator(
      'a:has-text("Documentation"), a:has-text("Docs"), a:has-text("View Doc")',
    );
  ...
  test("social links are present", async ({ page }) => {
    ...
    const discordLink = page.locator(
      'a:has-text("Discord"), a[href*="discord"]',
    );
    const twitterLink = page.locator(
      'a:has-text("Twitter"), a:has-text("X (Twitter)"), a[href*="twitter"], a[href*="x.com"]',
    );
...
test.describe("Marketplace - All Interactive Elements", () => {
  ...
  test("character cards have all buttons", async ({ page }) => {
    ...
    const cloneBtns = page.locator(
      'button:has-text("Clone character"), button:has-text("Clone")',
    );
    const viewBtns = page.locator(
      'button:has-text("View details"), button:has-text("View")',
    );
...
test.describe("Chat Page - Complete Testing", () => {
  ...
  test("character selector dropdown works", async ({ page }) => {
    const characterBtn = page.locator(
      'button:has-text("Default"), button:has-text("Eliza")',
    );
  ...
  test("model tier selector exists", async ({ page }) => {
    const tierSelector = page.locator(
      '[role="combobox"], select:has-text("Pro"), select:has-text("Fast")',
    );
  ...
  test("audio controls exist", async ({ page }) => {
    const micBtn = page.locator(
      'button[aria-label*="mic" i], button:has(svg[class*="mic" i])',
    );
...
test.describe("Static Pages", () => {
  test("terms of service is readable", async ({ page }) => {
    ...
    console.log(
      `✅ Terms page has ${content?.length} chars and ${headingCount} headings`,
    );
  });
...
test.describe("Responsive Interactions", () => {
  test("mobile menu works", async ({ page }) => {
    ...
    const menuBtn = page.locator(
      'button[aria-label*="menu" i], button:has(svg[class*="menu" i]), button[class*="hamburger" i]',
    );
