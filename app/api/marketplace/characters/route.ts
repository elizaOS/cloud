...
export async function GET(request: NextRequest) {
  try {
    ...
    const hasVoice = searchParams.has("hasVoice") ? searchParams.get("hasVoice") === "true" : undefined;
    const deployed = searchParams.has("deployed") ? searchParams.get("deployed") === "true" : undefined;
    const template = searchParams.has("template") ? searchParams.get("template") === "true" : undefined;
    const myCharacters = searchParams.has("myCharacters") ? searchParams.get("myCharacters") === "true" : undefined;
    const publicChars = searchParams.has("public") ? searchParams.get("public") === "true" : undefined;
