/**
 * Display helpers for Milady pricing.
 * Imports from the canonical milady-pricing.ts constants — never hardcodes rates.
 */

import { MILADY_PRICING } from "./milady-pricing";
