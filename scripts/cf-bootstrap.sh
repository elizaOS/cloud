...
#
# After running, paste the printed namespace IDs into cloud/packages/apps/api/wrangler.toml
...
echo "      cloud/packages/apps/api/wrangler.toml (kv_namespaces blocks)."
echo
...
echo
echo "  Next steps:"
echo "    1. Open cloud/packages/apps/api/wrangler.toml"
echo "    2. Replace each REPLACE_ME 'id' with the matching namespace ID"
echo "       printed above (SESSION_CACHE, RATE_LIMIT, CACHE)."
echo "    3. Set 'account_id' in cloud/packages/apps/api/wrangler.toml to your Cloudflare"
