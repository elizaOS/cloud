...
export const WithDescription: Story = {
  args: { label: "Settings", title: "API Keys", description: "Manage your API keys and access tokens for programmatic access." },
};
...
export const WithAction: Story = {
  args: {
    ...
    action: <button style={{ padding: "8px 16px", background: "#FF5800", color: "white", border: "none", cursor: "pointer" }}>Deploy New</button>,
  },
};
