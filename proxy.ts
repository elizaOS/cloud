...
const publicPaths = [
  ...
  "/api/v1/oauth/bluesky/client-metadata.json", // AT Protocol client metadata (fetched by auth servers)
  "/api/v1/oauth/bluesky/jwks.json", // AT Protocol JWKS (fetched by auth servers)
  "/api/v1/app-auth",
  "/app-auth",
  "/.well-known",
