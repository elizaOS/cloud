 ...
 * GET /api/v1/app/user
 *
 * Returns the current authenticated user's info for app consumption.
...
/**
 * OPTIONS /api/v1/app/user
 * CORS preflight handler for app user endpoint.
 *
...
/**
 * GET /api/v1/app/user
 * Returns the current authenticated user's information for app consumption.
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    logger.error("[App API] Error getting user", { error });
