...
export const oauthConnectAction: ActionWithParams = {
  ...
  similes: [
    ...
    "CONNECT_SALESFORCE", "LINK_SALESFORCE", "CONNECT_CRM", "LINK_CRM",
    "ADD_INTEGRATION", "SETUP_CONNECTION", "LINK_GOOGLE", "AUTHENTICATE",
    "LINK_LINEAR", "LINK_SLACK", "LINK_GITHUB", "LINK_NOTION",
  ],
  description:
    "Connect an OAuth platform for the user. Returns an authorization URL. After user completes OAuth in browser, they should say 'done' to verify the connection. Available: google, linear, slack, github, notion, salesforce",

  parameters: {
    platform: {
      type: "string",
      description: "Platform to connect. Available: google, linear, slack, github, notion, salesforce",
      required: true,
    },
  },
