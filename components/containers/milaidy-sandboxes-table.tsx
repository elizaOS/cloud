/**
 * Milaidy Sandboxes Table — lists AI agent sandboxes in the containers dashboard.
...
export interface MilaidySandboxRow {
  id: string;
...
interface MilaidySandboxesTableProps {
  sandboxes: MilaidySandboxRow[];
}
...
function isDockerBacked(sb: MilaidySandboxRow): boolean {
  return !!sb.node_id;
}

function getConnectUrl(sb: MilaidySandboxRow): string | null {
...
export function MilaidySandboxesTable({ sandboxes }: MilaidySandboxesTableProps) {
