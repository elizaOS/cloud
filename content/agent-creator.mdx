...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
  <div className="p-4 border border-white/10 bg-white/[0.02]">
    ...
    <p className="text-white/60 text-sm">Professional agent for business queries, scheduling, and communication.</p>
  </div>
  <div className="p-4 border border-white/10 bg-white/[0.02]">
    <h4 className="font-semibold mb-2">📚 Research Helper</h4>
    <p className="text-white/60 text-sm">Academic-focused agent for research and analysis.</p>
  </div>
  <div className="p-4 border border-white/10 bg-white/[0.02]">
    <h4 className="font-semibold mb-2">💻 Code Reviewer</h4>
    <p className="text-white/60 text-sm">Technical agent for code review and debugging.</p>
  </div>
  <div className="p-4 border border-white/10 bg-white/[0.02]">
    <h4 className="font-semibold mb-2">🎨 Creative Writer</h4>
    <p className="text-white/60 text-sm">Creative agent for writing, brainstorming, and content creation.</p>
  </div>
</div>
...
<Cards>
  <Cards.Card title="Be Specific" href="/docs/agent-creator">
    Detailed style instructions lead to more consistent behavior
  </Cards.Card>
  <Cards.Card title="Test Extensively" href="/docs/agent-creator">
    Try various scenarios in the preview before deploying
  </Cards.Card>
  <Cards.Card title="Iterate" href="/docs/agent-creator">
    Start simple and add complexity based on testing
  </Cards.Card>
  <Cards.Card title="Use Templates" href="/docs/agent-creator">
    Start from a template and customize for faster setup
  </Cards.Card>
</Cards>
