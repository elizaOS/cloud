...
```bash
curl -X POST "https://elizacloud.ai/api/mcp/demos/weather" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "jsonrpc": "2.0",
...
<Cards>
  <Cards.Card title="Minimal Tools" href="/docs/mcps">
    Only connect tools your agent needs
  </Cards.Card>
  <Cards.Card title="Test Thoroughly" href="/docs/mcps">
    Verify tools work before production
  </Cards.Card>
  <Cards.Card title="Handle Errors" href="/docs/mcps">
    MCP calls can fail - handle gracefully
  </Cards.Card>
  <Cards.Card title="Monitor Usage" href="/docs/mcps">
