  ...
  return (
    <div className={cn("grid gap-4 sm:grid-cols-2 lg:grid-cols-4", className)}>
      ...
      <Link
        ...
        className="group relative flex flex-col justify-between overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-violet-500/15 via-violet-600/10 to-transparent p-5 transition-all duration-300 hover:border-violet-500/40 hover:shadow-lg hover:shadow-violet-500/5"
      >
        <div className="mb-4 flex items-center justify-between">
      ...
      <Link
        ...
        className="group relative flex flex-col justify-between overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-emerald-500/15 via-emerald-600/10 to-transparent p-5 transition-all duration-300 hover:border-emerald-500/40 hover:shadow-lg hover:shadow-emerald-500/5"
      >
        <div className="mb-4 flex items-center justify-between">
      ...
      {/* Developer APIs */}
      <div className="group relative flex flex-col justify-between overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-cyan-500/15 via-cyan-600/10 to-transparent p-5 transition-all duration-300 hover:border-cyan-500/40 hover:shadow-lg hover:shadow-cyan-500/5">
        <div className="mb-4 flex items-center justify-between">
