...
export type CreditTransaction = InferSelectModel<typeof schema.creditTransactions>;
export type NewCreditTransaction = InferInsertModel<typeof schema.creditTransactions>;
