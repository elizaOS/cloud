...
<Cards>
  <Cards.Card title="Clear Schemas" href="/docs/mcp">
    Provide detailed input schemas
  </Cards.Card>
  <Cards.Card title="Good Descriptions" href="/docs/mcp">
    Help models understand tool purposes
  </Cards.Card>
  <Cards.Card title="Handle Errors" href="/docs/mcp">
    Return clear error messages
  </Cards.Card>
  <Cards.Card title="Validate Input" href="/docs/mcp">
