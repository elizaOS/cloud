...
```bash
curl -X GET "https://cloud.eliza.ai/api/v1/apps/{appId}/analytics" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X GET "https://cloud.eliza.ai/api/v1/apps/{appId}/users" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://cloud.eliza.ai/api/v1/apps/{appId}/monetization" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "enabled": true,
...
```bash
curl -X GET "https://cloud.eliza.ai/api/v1/apps/{appId}/earnings" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://cloud.eliza.ai/api/v1/apps/{appId}/regenerate-api-key" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
