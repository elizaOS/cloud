      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <div className="flex items-baseline gap-1.5">
                <span className="text-white font-bold text-lg tracking-tight">elizaOS</span>
                <span className="text-[#ff5800] font-bold text-lg tracking-tight">Cloud</span>
              </div>
            </div>
            <p className="text-white/50 text-sm leading-relaxed max-w-[300px] mb-6">
              The complete platform for building, deploying, and scaling intelligent AI agents. Trusted by developers worldwide.
            </p>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              <Link href="/docs/quickstart" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
              ...
              <Link href="/docs/api" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                API Reference
              </Link>
              <Link href="/docs/agents" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                AI Agents
              </Link>
              <Link href="/docs/sdks" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                SDKs
              </Link>
            </nav>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              <Link href="/dashboard" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                Dashboard
              </Link>
              <Link href="/docs/billing" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                Pricing
              </Link>
              <Link href="/docs/changelog" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                Changelog
              </Link>
              <a href="https://status.eliza.ai" target="_blank" rel="noopener noreferrer" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                Status
              </a>
            </nav>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              <a href="https://elizaos.ai" target="_blank" rel="noopener noreferrer" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                About
              </a>
              <Link href="/terms-of-service" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                Terms
              </Link>
              <Link href="/privacy-policy" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                Privacy
              </Link>
              <a href="mailto:support@eliza.ai" className="text-white/60 text-sm hover:text-[#ff5800] hover:translate-x-1 transition-all duration-200 flex items-center gap-2 group">
                <span className="w-1.5 h-1.5 rounded-full bg-white/20 group-hover:bg-[#ff5800] group-hover:shadow-[0_0_8px_rgba(255,88,0,0.5)] transition-all" />
                Contact
              </a>
            </nav>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-5 pt-8 border-t border-white/[0.06]">
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-2 text-white/25 text-xs font-mono">
            ...
            <span>© elizaOS</span>
            <span className="text-white/10">|</span>
            <span className="text-white/40 hidden md:inline">Built for developers who ship</span>
          </div>
