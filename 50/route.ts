...
// Check if this is a valid topup amount
if (!ALLOWED_AMOUNTS.includes(AMOUNT)) {
    throw new Error(`Invalid topup amount: ${AMOUNT}. Allowed values are: ${ALLOWED_AMOUNTS.join(', ')}`);
}
...
// Ensure the recipient address is set via ENV
