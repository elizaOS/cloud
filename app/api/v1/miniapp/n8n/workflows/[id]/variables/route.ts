/**
 * Miniapp N8N Workflow Variables API
 *
 * GET /api/v1/miniapp/n8n/workflows/:id/variables - List workflow variables
 * POST /api/v1/miniapp/n8n/workflows/:id/variables - Create workflow variable
 */
...
/**
 * GET /api/v1/miniapp/n8n/workflows/:id/variables
...
export async function GET(
  ...
  try {
    ...
    logger.error("[Miniapp N8N Variables] Error listing workflow variables:", error);
    return NextResponse.json(
      {
        success: false,
...
/**
 * POST /api/v1/miniapp/n8n/workflows/:id/variables
...
export async function POST(
  ...
  try {
    ...
    logger.error("[Miniapp N8N Variables] Error creating workflow variable:", error);
    return NextResponse.json(
      {
        success: false,
