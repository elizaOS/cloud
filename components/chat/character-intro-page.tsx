        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className={`text-4xl font-bold mb-2 ${
              ...
              {theme.branding.title === "Clone Your Crush" ? "Meet Your Crush" : theme.branding.title === "Edad" ? "Meet Your AI Dad" : "Meet Your AI Companion"}
            </h1>
            <p className={isCustomTheme ? 'text-white/60' : 'text-muted-foreground'}>
          ...
          <Card className={`mb-8 overflow-hidden ${
            ...
            <CardContent className="p-8">
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                {/* Name and Vibe */}
                <div>
                  <h2 className={`text-3xl font-bold mb-2 ${isCustomTheme ? 'text-white' : ''}`}>
                    {character.name}
                  </h2>
                ...
                >
                  ...
                  <p className={`text-sm ${isCustomTheme ? 'text-white/50' : 'text-muted-foreground'}`}>
                ...
                <CardContent className="p-6 text-center">
                  <div className={`inline-flex items-center justify-center w-12 h-12 rounded-full mb-4 ${
                    ...
                    <Icon className={`w-6 h-6 ${
                      isCustomTheme ? 'text-[rgb(var(--theme-primary-light))]' : 'text-primary'
                    }`} />
                  </div>
                  <h3 className={`font-semibold mb-2 ${isCustomTheme ? 'text-white' : ''}`}>{title}</h3>
                  <p className={`text-sm ${isCustomTheme ? 'text-white/60' : 'text-muted-foreground'}`}>
                    {desc}
                  </p>
                </CardContent>
              </Card>
          ...
          >
            <h3 className={`text-xl font-semibold ${isCustomTheme ? 'text-white' : ''}`}>How It Works</h3>
