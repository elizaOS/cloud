...
const BayerDitheringBackgroundComponent = dynamic(() => import("./BayerDitheringBackground"), {
  ssr: false,
  loading: () => (
...
export const BayerDitheringBackgroundLazy = (props: BayerDitheringBackgroundProps) => {
