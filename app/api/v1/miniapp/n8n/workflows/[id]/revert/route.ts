/**
 * Miniapp N8N Workflow Revert API
 *
 * POST /api/v1/miniapp/n8n/workflows/:id/revert - Revert workflow to a version
 */
...
/**
 * POST /api/v1/miniapp/n8n/workflows/:id/revert
...
export async function POST(
  ...
  try {
    ...
    logger.error("[Miniapp N8N Workflows] Error reverting workflow:", error);
    return NextResponse.json(
      {
        success: false,
