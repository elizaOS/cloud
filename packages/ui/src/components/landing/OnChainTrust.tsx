      ...
      <div className="flex flex-col px-4 relative z-10">
        ...
        <div className="mb-8 md:mb-8 flex flex-col md:flex-row items-start md:justify-between gap-6">
          <div className="max-w-4xl">
            ...
            >
              Fully autonomous agents that utilize 8004 & x402 to find agents, understand their
              reputation and securely take part in agentic commerce.
            </motion.p>
          </div>
        </div>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1 mb-1" style={{ color: "#FF5800" }}>
                          ...
                          <span className="text-[10px] select-none">ERC-8004 Verified</span>
                        </div>
                        <div className="flex items-center gap-1 text-white/40">
                          ...
                          <span className="text-[10px] font-mono select-none">{agent.address}</span>
                        </div>
                      </div>
                    </div>
                  </div>
