...
<Cards>
  <Cards.Card title="Organize Early" href="/docs/gallery">
    Use collections and tags from the start
  </Cards.Card>
  <Cards.Card title="Clean Up" href="/docs/gallery">
    Delete unwanted generations to save storage
  </Cards.Card>
  <Cards.Card title="Backup" href="/docs/gallery">
    Download important content periodically
  </Cards.Card>
  <Cards.Card title="Share Wisely" href="/docs/gallery">
