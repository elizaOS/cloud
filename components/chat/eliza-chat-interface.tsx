          ...
          <div className="space-y-2">
            ...
            <div className="relative rounded-none border-2 border-border shadow-sm bg-black/20 overflow-hidden">
              ...
              <textarea
                ...
                rows={1}
                className="w-full bg-transparent px-3 py-2.5 text-sm text-white placeholder:text-white/60 resize-none focus:outline-none disabled:opacity-50 overflow-hidden max-h-40 overflow-y-auto"
              />
            </div>
