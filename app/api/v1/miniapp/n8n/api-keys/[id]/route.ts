/**
 * Miniapp N8N API Key API - Individual Key
 *
 * DELETE /api/v1/miniapp/n8n/api-keys/:id - Delete API key
 */
...
/**
 * DELETE /api/v1/miniapp/n8n/api-keys/:id
 * Deletes an API key.
 */
export async function DELETE(
  ...
  try {
    ...
    logger.info(`[Miniapp N8N API Keys] Deleted API key: ${id}`);
    ...
    logger.error("[Miniapp N8N API Keys] Error deleting API key:", error);
    return NextResponse.json(
      {
        success: false,
