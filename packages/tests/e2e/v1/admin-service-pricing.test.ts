...
describe("Admin Service Pricing API", () => {
  ...
  test.skipIf(!api.hasApiKey())(
    "GET /api/v1/admin/service-pricing requires service_id even for authenticated admins",
    async () => {
  ...
  test.skipIf(!api.hasApiKey())(
    "PUT /api/v1/admin/service-pricing rejects invalid payloads over the real route",
    async () => {
