...
<Cards>
  <Cards.Card title="Handle All Errors" href="/docs/errors">
    Never assume requests will succeed
  </Cards.Card>
  <Cards.Card title="Log Errors" href="/docs/errors">
    Log error codes and request IDs
  </Cards.Card>
  <Cards.Card title="User Feedback" href="/docs/errors">
    Show meaningful error messages to users
  </Cards.Card>
  <Cards.Card title="Graceful Degradation" href="/docs/errors">
