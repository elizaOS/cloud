/**
 * App N8N Variables API
 *
 * GET /api/v1/app/n8n/variables - List variables (global)
 * POST /api/v1/app/n8n/variables - Create variable
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[App N8N Variables] Created variable: ${name}`, {
      appId: app.id,
