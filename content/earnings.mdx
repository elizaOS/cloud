...
<Cards>
  <Cards.Card title="Quality First" href="/docs/earnings">
    High-quality agents earn more through ratings and usage
  </Cards.Card>
  <Cards.Card title="Clear Pricing" href="/docs/earnings">
    Transparent pricing builds user trust
  </Cards.Card>
  <Cards.Card title="Good Description" href="/docs/earnings">
    Detailed listings get more visibility
  </Cards.Card>
  <Cards.Card title="Iterate" href="/docs/earnings">
