      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Badge variant="secondary" className="rounded-full">
            {numberFormatter.format(totalRequests)} total
          </Badge>
        </div>
      </CardHeader>
      <Separator />
        ...
        <div className="flex flex-col gap-4">
          <div className="grid gap-4 rounded-xl border border-border/60 bg-gradient-to-br from-background to-muted/20 p-5 sm:grid-cols-3">
            <div className="space-y-2">
              ...
              <Badge
                variant="secondary"
                className="gap-1 rounded-full bg-emerald-500/10 text-emerald-500"
              >
            ...
            <div className="space-y-2">
              ...
              <Badge
                variant="secondary"
                className="gap-1 rounded-full bg-rose-500/10 text-rose-500"
              >
