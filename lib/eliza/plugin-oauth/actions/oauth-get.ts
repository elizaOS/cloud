...
export const oauthGetAction: ActionWithParams = {
  ...
  similes: [
    ...
    "CHECK_LINKEDIN", "VERIFY_LINKEDIN",
  ],
  description:
  ...
  parameters: {
    platform: {
      type: "string",
      description: "Platform to check: google, linear, slack, github, notion, linkedin. If not specified, checks all.",
      required: false,
    },
  },
  ...
  examples: [
    ...
    [
      { name: "{{name1}}", content: { text: "is my linkedin connected?" } },
      { name: "{{name2}}", content: { text: "LinkedIn connected! Logged in as John Doe.", actions: ["OAUTH_GET"] } },
    ],
  ] as ActionExample[][],
};
