/**
 * Docker Logs Viewer — fetches raw docker logs for a milaidy sandbox container.
...
interface DockerLogsViewerProps {
  sandboxId: string;          // milaidy_sandbox.id (UUID)
...
export function DockerLogsViewer({
  ...
  const filteredLines = logsState.lines.filter((line) =>
