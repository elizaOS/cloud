...
/**
 * OPTIONS /api/v1/app/agents/[id]/chats/[chatId]/messages
 * CORS preflight handler for app message endpoint.
 *
...
/**
 * POST /api/v1/app/agents/[id]/chats/[chatId]/messages
...
export async function POST(
  ...
  try {
    ...
    logger.info("[App API] Message access validated", {
      chatId,
      agentId,
      userId: user.id,
    });
    ...
    logger.error("[App API] Error validating message", {
      error,
      chatId,
      agentId,
    });
