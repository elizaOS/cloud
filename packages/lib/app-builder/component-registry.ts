...
<ElizaAuthProvider>
  ...
  LoginButton: {
    ...
    example: `import { LoginButton } from "@elizaos/cloud-ui/components/eliza/auth/login-button";
...
/>`,
  ...
  UserProfile: {
    ...
    example: `import { UserProfile } from "@elizaos/cloud-ui/components/eliza/auth/user-profile";
...
<UserProfile showCredits onLogout={() => router.push('/')} />`,
  ...
  ProtectedRoute: {
    ...
    example: `import { ProtectedRoute } from "@elizaos/cloud-ui/components/eliza/auth/protected-route";
...
export default function DashboardPage() {
  ...
  StreamingChat: {
    ...
    example: `import { StreamingChat } from "@elizaos/cloud-ui/components/eliza/chat/streaming-chat";
...
/>`,
  ...
  MessageList: {
    ...
    example: `import { MessageList } from "@elizaos/cloud-ui/components/eliza/chat/message-list";
...
/>`,
  ...
  MessageInput: {
    ...
    example: `import { MessageInput } from "@elizaos/cloud-ui/components/eliza/chat/message-input";
...
/>`,
  ...
  CreditBalance: {
    ...
    example: `import { CreditBalance } from "@elizaos/cloud-ui/components/eliza/billing/credit-balance";
...
<CreditBalance showTopUp refreshInterval={30000} />`,
  ...
  UsageChart: {
    ...
    example: `import { UsageChart } from "@elizaos/cloud-ui/components/eliza/billing/usage-chart";
...
<UsageChart period="30d" height={300} />`,
  ...
  PricingTable: {
    ...
    example: `import { PricingTable } from "@elizaos/cloud-ui/components/eliza/billing/pricing-table";
...
<PricingTable features={['chat', 'image', 'video']} />`,
  ...
  AgentCard: {
    ...
    example: `import { AgentCard } from "@elizaos/cloud-ui/components/eliza/agents/agent-card";
...
/>`,
  ...
  AgentList: {
    ...
    example: `import { AgentList } from "@elizaos/cloud-ui/components/eliza/agents/agent-list";
...
/>`,
  ...
  AgentChat: {
    ...
    example: `import { AgentChat } from "@elizaos/cloud-ui/components/eliza/agents/agent-chat";
...
/>`,
  ...
  ImageGenerator: {
    ...
    example: `import { ImageGenerator } from "@elizaos/cloud-ui/components/eliza/media/image-generator";
...
/>`,
  ...
  VideoGenerator: {
    ...
    example: `import { VideoGenerator } from "@elizaos/cloud-ui/components/eliza/media/video-generator";
...
<VideoGenerator onGenerate={(url) => logger.debug(url)} />`,
  ...
  DashboardLayout: {
    ...
    example: `import { DashboardLayout } from "@elizaos/cloud-ui/components/eliza/layout/dashboard-layout";
...
export default function DashboardPage() {
  ...
  Sidebar: {
    ...
    example: `import { Sidebar } from "@elizaos/cloud-ui/components/eliza/layout/sidebar";
...
<Sidebar items={items} />`,
  ...
  Header: {
    ...
    example: `import { Header } from "@elizaos/cloud-ui/components/eliza/layout/header";
...
export function generateCompactCatalog(): string {
  ...
  catalog += `\`\`\`tsx
// Auth
import { LoginButton, UserProfile, ProtectedRoute } from "@elizaos/cloud-ui/components/eliza/auth";

// Chat
import { StreamingChat, MessageList, MessageInput } from "@elizaos/cloud-ui/components/eliza/chat";

// Billing  
import { CreditBalance, UsageChart } from "@elizaos/cloud-ui/components/eliza/billing";

// Agents
import { AgentCard, AgentList, AgentChat } from "@elizaos/cloud-ui/components/eliza/agents";

// Layout
import { DashboardLayout, Sidebar, Header } from "@elizaos/cloud-ui/components/eliza/layout";

// Media
import { ImageGenerator, VideoGenerator } from "@elizaos/cloud-ui/components/eliza/media";
\`\`\`\n`;
