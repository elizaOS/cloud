...
const FIRST_NAMES = [
  "Nova", "Echo", "Pixel", "Byte", "Vector", "Cipher", "Nexus", "Flux",
  "Atlas", "Phoenix", "Orion", "Luna", "Aurora", "Iris", "Cleo", "Apollo",
  "Sage", "River", "Storm", "Ember", "Ash", "Sky", "Coral", "Frost",
  "Aria", "Felix", "Maya", "Leo", "Mira", "Kai", "Zara", "Quinn",
  "Stella", "Jasper", "Ruby", "Onyx", "Pearl", "Jade", "Opal", "Raven",
  "Zephyr", "Cosmo", "Astrid", "Blaze", "Lyra", "Solara", "Vega", "Nyx",
] as const;
