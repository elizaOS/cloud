...
ALTER TABLE "central_messages" ADD CONSTRAINT "fk_reply_to_message" FOREIGN KEY ("in_reply_to_root_message_id") REFERENCES "public"."central_messages"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "containers_org_status_idx" ON "containers" USING btree ("organization_id","status");--> statement-breakpoint
